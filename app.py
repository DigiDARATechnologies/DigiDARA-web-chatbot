...
def chat():
    ...
    if request.method != 'POST':
        ...
        return jsonify({'response': "Invalid request method. Please use POST.", 'quickReplies': None}), 405
    ...
    try:
        ...
        return jsonify({'response': "Internal server error. Please try again later.", 'quickReplies': None}), 500
